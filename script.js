...
window.onload = function() {
  ...
  document.getElementById("buy").addEventListener('click',function() { 
        document.getElementById("wait").src = "https://i.gifer.com/1LBN.gif";
    // ADDING YOUR PURCHASE EVENT CODE HERE
    
    
    
    // Pretend I am calling my own api server for the buying request, which takes 5 s
    setTimeout(function(){
